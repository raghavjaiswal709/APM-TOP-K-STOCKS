...
for c in avatar breadcrumb button calendar card collapsible dropdown-menu form input label popover radio-group scroll-area select separator sheet sidebar skeleton toast toaster tooltip; do
