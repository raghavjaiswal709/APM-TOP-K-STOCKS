...
//   // **SIMPLIFIED STATE MANAGEMENT** - No complex zoom preservation
...
//   // **SIMPLIFIED REFS** - Remove complex zoom state management
...
//     const currentOpen = parseFloat(current.open_price);
//     const currentClose = parseFloat(current.close_price);
...
//   // **OPTIMIZED PLOT DATA GENERATION** - Reduced dependencies
...
//   // **SIMPLIFIED LAYOUT** - No complex zoom logic
//   const layout = useMemo(() => {
//     // Calculate subplot domains for indicators
...
//       //   // **SIMPLIFIED** - Let user control zoom naturally
//       //   autorange: true,
//       //   fixedrange: false,
//       //   rangebreaks: [
//       //   { 
...
//       //   },
//       //   {
//       //     bounds: [15.5, 9.25], // Hide non-market hours (3:30 PM to 9:15 AM)
//       //     pattern: 'hour'
//       //   }
//       // ]
//       // },
...
//   tickfont: { color: colors.text, size: 10 },
//   title: { text: '', font: { color: colors.text } },
//   autorange: true, // Disable automatic range adjustments
//   fixedrange: false, // Allow user-controlled zooming and panning
//   range: ['2025-01-01', '2025-12-31'], // Set your desired initial date range
//   rangebreaks: [
//     { bounds: ['sat', 'mon'], pattern: 'day of week' }, // Hide weekends
//     { bounds: [15.5, 9.25], pattern: 'hour' } // Hide non-market hours
//   ]
// },
...
//   autorange: true, // Disable automatic range adjustments
//   fixedrange: false, // Allow user-controlled zooming and panning
//   range: [100, 1000] // Set your desired initial y-axis range
// },

// layout: {
//   uirevision: 'static' // Maintain user-defined view on updates
// }
// ,
...
//   // **OPTIMIZED EVENT HANDLERS** - No debouncing, direct state updates
...
//   // **SIMPLIFIED PLOT EVENT HANDLERS**
...
//     // Let Plotly handle zoom/pan naturally - no interference
//   }, []);
...
//       <div 
//         style={{ 
//           marginLeft: sidebarVisible ? '300px' : '0px',
//           transition: 'margin-left 0.3s ease',
//           height: '100%',
//           width: sidebarVisible ? `${width - 300}px` : `${width}px`
//         }}
//       >
//         <Plot
//           ref={plotRef}
...
//   exportToCSV: (data: StockDataPoint[], filename: string) => {
//     const csvContent = [
//       'Date,Open,High,Low,Close,Volume',
//       ...data.map(item => 
//         `${item.interval_start},${item.open},${item.high},${item.low},${item.close},${item.volume}`
...
export function StockChart({
  ...
  const layout = useMemo(() => {
    ...
    const baseLayout: any = {
      ...
      // Volume panel
      yaxis2: {
        title: { text: 'Volume', font: { color: colors.text, size: responsiveFonts.axis - 2 } },
        autorange: true,
        domain: volumeDomain,
        showgrid: false,
        gridcolor: colors.grid,
